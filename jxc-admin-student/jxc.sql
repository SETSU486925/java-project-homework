...
-- ----------------------------
INSERT INTO `persistent_logins` VALUES ('admin', '2eYiRK+p0882pdtogwEYqQ==', 'biRZCWsBdUSPbJ8K5siEYA==', '2022-03-12 10:51:53');
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '客户表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '客户退货单表' ROW_FORMAT = Compact;
...
INSERT INTO `t_customer_return_list` VALUES (7, 161, 161, '2022-01-22 00:00:00', 'XT202201210001', '', 1, 1, 2);
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '客户退货单商品表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '报损单表' ROW_FORMAT = Compact;
...
INSERT INTO `t_damage_list` VALUES (12, '2022-01-22 00:00:00', 'BS202201220001', '', 1);
INSERT INTO `t_damage_list` VALUES (13, '2022-01-22 00:00:00', 'BS202201220001', '', 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '报损单商品表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 39 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品表' ROW_FORMAT = Compact;
...
CREATE TABLE `t_goods_type`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品类别表' ROW_FORMAT = Compact;
...
CREATE TABLE `t_goods_unit`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品单位表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3227 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '报溢单表' ROW_FORMAT = Compact;
...
INSERT INTO `t_overflow_list` VALUES (10, '2022-01-22 00:00:00', 'BY202201220001', '', 1);
INSERT INTO `t_overflow_list` VALUES (11, '2022-01-22 00:00:00', 'BY202201220002', '', 1);
INSERT INTO `t_overflow_list` VALUES (12, '2022-01-22 00:00:00', 'BY202201220003', '', 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '报溢单商品表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 73 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '进货单' ROW_FORMAT = Compact;
...
INSERT INTO `t_purchase_list` VALUES (29, 463, 463, '2022-01-19 00:00:00', 'cc', 1, 'JH201711030001', 1, 1);
...
INSERT INTO `t_purchase_list` VALUES (56, 17, 17, '2022-01-21 00:00:00', '', 1, 'JH202201210001', 3, 1);
INSERT INTO `t_purchase_list` VALUES (70, 25.5, 25.5, '2022-01-21 00:00:00', '', 1, 'JH202201210002', 2, 1);
INSERT INTO `t_purchase_list` VALUES (72, 56, 56, '2022-03-12 00:00:00', '', 1, 'JH202203110001', 3, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 68 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '进货单商品表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '退货单表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '退货单商品表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 153 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色菜单表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '销售单表' ROW_FORMAT = Compact;
...
INSERT INTO `t_sale_list` VALUES (28, 1, 666, '', '2022-01-21 00:00:00', 'XS202201210001', 1, 1, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '销售单商品表' ROW_FORMAT = Compact;
...
CREATE TABLE `t_supplier`  (
  ...
  `is_del` int(11) NULL DEFAULT NULL COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '供应商表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 47 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户角色表' ROW_FORMAT = Compact;
